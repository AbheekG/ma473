function q1
	...
	figure; plot(S(indices), U(end, indices)); hold on; plot(S(indices), U(1, indices)); hold off;
	legend('Cost of option at t = 0', 'Cost of option at t = T'); xlabel('S'); ylabel('u(S, t)'); title(sprintf('BTCS using PSOR method'));
